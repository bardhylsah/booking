<?php 
include ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Components/header.php');
require_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Authentication/view/booksviewer.php');
    ...
    <main>
        ...
        <div class="content">
            ...
            <div>
                ...
                <div>
                    <?php if ($book [4] ['Image']): ?>
                                <img class="img-books" src="<?php echo $book[4] ['Image']; ?>" >
                            <?php else: ?>
                                    <p>No image Selected</p>
                            <?php endif?> <br>
                            <p><a href="book.php?title=<?php echo $book[4]['Title'];?>" name='book' class="book-link"><b><?php echo $book[4]['Title'];?></b><br>by
                                <?php echo $book[4]['Author']; ?></a></p> 
                </div>
            </div>
