<?php
require_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Authentication/login.php');
require_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Authentication/models/contacts.php');
require_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Authentication/view/contactviewer.php');
require_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Authentication/Controller/contactcontr.php');
session_start();
