<?php require_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Authentication/view/aboutviewer.php');

require_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Authentication/search.php');
include_once ($_SERVER['DOCUMENT_ROOT'].'/Book-with-us-main/Components/header.php');
